...
/* harmony export */ });
var randy = function randy(min, max) {
  return Math.floor(Math.random() * (max - min) + min);
};

var geraMaiuscula = function geraMaiuscula() {
  return String.fromCharCode(randy(65, 91));
};

var geraMenuscula = function geraMenuscula() {
  return String.fromCharCode(randy(97, 123));
};

var geraNumeros = function geraNumeros() {
  return String.fromCharCode(randy(48, 58));
};

var sinbolo = ',.;/<>:[]{}~´^``!@#$%¨&*()_-+=';

var gerasinbolo = function gerasinbolo() {
  return sinbolo[randy(0, sinbolo.length)];
};

function geraSenha(qtd, maiuscula, menuscula, numeros, sinbolos) {
  var senhaarray = [];
  qtd = Number(qtd);
...
var Validacpf = /*#__PURE__*/function () {
  ...
  _createClass(Validacpf, [{
    ...
    value: function eSequencia() {
      var seq = this.limpo[0].repeat(this.limpo.length);
      return seq === this.limpo;
    }
  }, {
    key: "separador",
    value: function separador() {
      var cpfparcial = this.limpo.slice(0, -2);
    ...
    key: "criadigito",
    value: function criadigito(parciall) {
      var total = 0;
      var reverso = parciall.length + 1;

      var _iterator = _createForOfIteratorHelper(parciall),
          _step;

      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var _digito = _step.value;
          total += reverso * Number(_digito);
          reverso--;
        }
      } catch (err) {
        _iterator.e(err);
...
var numerica = document.querySelector('.qtd-numerica');
var maiuscula = document.querySelector('.chk-maiuscula');
var menuscula = document.querySelector('.chk-menuscula');
var numeros = document.querySelector('.chk-numeros');
var sinbolo = document.querySelector('.chk-sinbolos');
var btn = document.querySelector('.gerar-senha');
var resss = document.querySelector('.senha-gerada');
...
function gerar() {
  var senha = (0,_Geradores__WEBPACK_IMPORTED_MODULE_0__["default"])(numerica.value, maiuscula.checked, menuscula.checked, numeros.checked, sinbolo.checked);
  return senha;
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ Gerandocpf)
/* harmony export */ });
...
var Gerandocpf = /*#__PURE__*/function () {
  function Gerandocpf() {
    _classCallCheck(this, Gerandocpf);
  ...
  _createClass(Gerandocpf, [{
    key: "separa",
    value: function separa(cpf) {
      return cpf.slice(0, 3) + '.' + cpf.slice(3, 6) + '.' + cpf.slice(6, 9) + '-' + cpf.slice(9, 11);
    }
  }, {
    key: "geradigito",
    value: function geradigito() {
      var parcisal = this.rand();
      var digito1 = _ValidaCPF__WEBPACK_IMPORTED_MODULE_0__["default"].criadigito(parcisal);
      var digito2 = _ValidaCPF__WEBPACK_IMPORTED_MODULE_0__["default"].criadigito(parcisal + digito1);
      var novocpf = parcisal + digito1 + digito2;
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body{ background: rgb(195, 248, 5); }\r\nh1{font-size: 50px; text-align: center; color: rgb(233, 13, 233);}\r\nh6, p{font-size: 50px; color: red; text-align: center;}\r\n\r\n.gerando{\r\n    width: 20%;\r\n    background: aqua;\r\n}\r\n\r\n.validoInvalido{\r\n    width: 20%;\r\n    background: aqua;\r\n}\r\n\r\n.gerasenha{\r\n    width: 20%;\r\n    background: aqua;\r\n}", "",{"version":3,"sources":["webpack://./src/assets/css/style.css"],"names":[],"mappings":"AAAA,MAAM,4BAA4B,EAAE;AACpC,GAAG,eAAe,EAAE,kBAAkB,EAAE,wBAAwB,CAAC;AACjE,MAAM,eAAe,EAAE,UAAU,EAAE,kBAAkB,CAAC;;AAEtD;IACI,UAAU;IACV,gBAAgB;AACpB;;AAEA;IACI,UAAU;IACV,gBAAgB;AACpB;;AAEA;IACI,UAAU;IACV,gBAAgB;AACpB","sourcesContent":["body{ background: rgb(195, 248, 5); }\r\nh1{font-size: 50px; text-align: center; color: rgb(233, 13, 233);}\r\nh6, p{font-size: 50px; color: red; text-align: center;}\r\n\r\n.gerando{\r\n    width: 20%;\r\n    background: aqua;\r\n}\r\n\r\n.validoInvalido{\r\n    width: 20%;\r\n    background: aqua;\r\n}\r\n\r\n.gerasenha{\r\n    width: 20%;\r\n    background: aqua;\r\n}"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _modules_geraCPF__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/geraCPF */ "./src/modules/geraCPF.js");
/* harmony import */ var _modules_ValidaCPF__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/ValidaCPF */ "./src/modules/ValidaCPF.js");
/* harmony import */ var _modules_formGerasenha__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/formGerasenha */ "./src/modules/formGerasenha.js");
...
(0,_modules_formGerasenha__WEBPACK_IMPORTED_MODULE_5__["default"])(); // gera cpf

(function () {
  var gera = new _modules_geraCPF__WEBPACK_IMPORTED_MODULE_3__["default"]();
...
(function () {
  var display = document.querySelector('.envcpf');
  var btn = document.querySelector('.btn');
  var resultado = document.querySelector('.encpf');
  btn.addEventListener('click', function () {
    var cpf = new _modules_ValidaCPF__WEBPACK_IMPORTED_MODULE_4__["default"](display.value);
